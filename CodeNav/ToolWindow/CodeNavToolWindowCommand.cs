...
namespace CodeNav.ToolWindow
{
    ...
    internal sealed class CodeNavToolWindowCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CodeNavToolWindowCommand"/> class.
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(CodeNavToolWindow), 0, true);
