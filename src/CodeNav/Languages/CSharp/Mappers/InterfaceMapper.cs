...
public class InterfaceMapper(BaseMapper baseMapper)
{
    ...
    public List<CodeImplementedInterfaceItem> MapImplementedInterfaces(SyntaxNode member,
    ...
    public CodeInterfaceItem? MapInterface(InterfaceDeclarationSyntax? member,
        SemanticModel semanticModel, SyntaxTree tree,
        CodeDocumentViewModel codeDocumentViewModel, DocumentMapper documentMapper)
    {
        if (member == null)
