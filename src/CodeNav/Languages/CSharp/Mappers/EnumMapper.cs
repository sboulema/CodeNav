...
public class EnumMapper(BaseMapper baseMapper)
{
    public CodeItem MapEnumMember(EnumMemberDeclarationSyntax member,
    ...
    public CodeClassItem MapEnum(EnumDeclarationSyntax member,
