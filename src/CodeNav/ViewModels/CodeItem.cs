...
using Selection = Microsoft.VisualStudio.Extensibility.Editor.Selection;
...
public class CodeItem : NotifyPropertyChangedObject
{
    ...
    public TextViewService? TextViewService { get; set; }
    ...
    public async Task ClickItem(object? commandParameter, IClientContext clientContext, CancellationToken cancellationToken)
    {
        ...
        if (TextViewService != null)
        {
            await TextViewService.TextViewScrollToSpan(span.Start, span.Length);
        }
