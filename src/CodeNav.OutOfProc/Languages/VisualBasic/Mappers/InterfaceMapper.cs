...
public static class InterfaceMapper
{
    ...
    public static CodeInterfaceItem? MapInterface(InterfaceBlockSyntax? member,
        SemanticModel semanticModel, SyntaxTree tree, CodeDocumentViewModel codeDocumentViewModel)
    {
        if (member == null)
        {
        ...
        var codeItem = BaseMapper.MapBase<CodeInterfaceItem>(member, semanticModel, codeDocumentViewModel,
