...
public class CodeDocumentViewModel : NotifyPropertyChangedObject
{
    ...
    {
        await SettingsHelper.SaveSortOrder(clientContext.Extensibility, SortOrderEnum.SortByName, cancellationToken);
    ...
    {
        await SettingsHelper.SaveSortOrder(clientContext.Extensibility, SortOrderEnum.SortByFile, cancellationToken);
    ...
    private async Task Settings(object? commandParameter, IClientContext clientContext, CancellationToken cancellationToken)
    {
        ...
        CodeDocumentService.SettingsDialogData = await SettingsHelper.GetSettings(clientContext.Extensibility, cancellationToken);
        ...
        await SettingsHelper.SaveSettings(clientContext.Extensibility, CodeDocumentService.SettingsDialogData, cancellationToken);
    }
    ...
    private async Task Filter(object? commandParameter, IClientContext clientContext, CancellationToken cancellationToken)
    {
        ...
        CodeDocumentService.FilterDialogData = await SettingsHelper.GetFilterRules(clientContext.Extensibility, cancellationToken);
        ...
        await SettingsHelper.SaveSettings(clientContext.Extensibility, CodeDocumentService.FilterDialogData, cancellationToken);
