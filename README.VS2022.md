...
# NOTE: This version of CodeNav is not supported anymore, please upgrade to the newly refactored v10 version: [CodeNav - VS Marketplace](https://marketplace.visualstudio.com/items?itemName=SamirBoulema.CodeNav2026)
