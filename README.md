...
- Pin a document to keep the CodeNav window open for that document even when switching to other documents
- Open a second CodeNav window, to navigate multiple documents
